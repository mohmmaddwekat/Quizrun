...
class Controller extends BaseController
{
	...
	/**
	 * Render views with teacher layout
	 *
	 ...
	 * @return void
	 */
    public function teacherTemplate($page , $page_title, $data = []){
        // prep.  data
		...
		$content['theme'] = $theme;
		$content['view_file'] = 'teacher.' . $page;

		$content['page_title'] = $page_title;

		$content['controller_data'] = $data;

		echo view('teacher.layout.app', $content);
