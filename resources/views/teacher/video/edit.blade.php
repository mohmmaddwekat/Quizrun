      ...
      <section class="content">
          <div class="container-fluid">
              <div class="card card-default">
                  ...
                  <form action="{{ route('teacher.video.update', $video->id) }}" method="post"
                          ...
                          <div class="row">
                              <div class="col-md-6">
                                  <div class="form-group">
                                      ...
                                      <div class="input-group video">
                                          <input type="file" name="video" accept="video/mp4" onchange="readVideo(this);"
                                              class="custom-file-input  @error('video', $video->video) is-invalid @enderror"
                                              id="exampleInputFile">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <img @if (!$video->Poster) id="blah" @endif
                                          src="@if ($video->Poster) {{ url('/assets/uploads/' . $video->Poster) }} @endif"
                                      ...
                                      <select class="form-control  selectpicker @error('section') is-invalid @enderror"
                                          ...
                                          @foreach ($sections as $section)
                                              <option value="{{ $section->id }}"
                                                  @if (old('section', $video->section_id) && old('section', $video->section_id) == $section->id) selected @endif>
