      ...
      <section class="content">
          <div class="container-fluid">
              <div class="card card-default">
                  ...
                  <form action="{{ route('teacher.section.save') }}" method="post" enctype="multipart/form-data">
                      <!-- /.card-header -->
                      @if ($errors->any())
                              ...
                              <div class="col-md-6">
                                  <div class="form-group has-validation">
                                      ...
                                      <input type="text" class="form-control @error('title') is-invalid @enderror"
                                          name="title" value="{{ old('title') }}" id="exampleInputName1"
                                  ...
                                  <div class="form-group">
                                      ...
                                      <select class="form-control  selectpicker @error('course') is-invalid @enderror"
                                          ...
                                          @foreach ($courses as $course)
                                              @if ($course->section()->count() < $course->number_of_sections)
                                                  <option value="{{ $course->id }}"
                                                      @if (old('course') && old('course') == $course->id) selected @endif>
                                                      {{ $course->name }}
                                                  </option>
                                              @endif
                                          @endforeach
