                    ...
                    <div class="card-body">
                        ...
                        <div class="direct-chat-messages chat-messages" style="height:60vh">
                            ...
                            @foreach ($messages as $message)
                                @if ($message->teacher_id)
                                    <div class="direct-chat-msg right msg">
                                        <div class="direct-chat-infos clearfix">
                                            <span
                                                class="direct-chat-name float-right">{{ $message->teacher->name }}</span>
                                            <span
...
<script>
    var intervalId = window.setInterval(function() {
        $.ajax({
            ...
            url: "/teacher/message/add/" + {{ $forum->id }},
            ...
            success: function(results) {
                if (results.length) {
                    ...
                    results.forEach(result => {
                        let path = "/avatar-placeholder.png";
                        ...
                        if (result['teacher_id']) {
                            if (result['teacher']['image']) {
                                path = result['teacher']['image'];
                            }
                            $(".chat-messages").append(
                                `<div class="direct-chat-msg right msg">
                                <div class="direct-chat-infos clearfix">
                                    <span class="direct-chat-name float-right">${ result['teacher']['name'] }</span>
            ...
            if (msg) {
                if (/[!@#$%^&*()_+.,;:]/.test(msg) == false) {
                    ...
                    $.ajax({
                        ...
                        url: "/teacher/message/save/" + {{ $forum->id }} + '/' + $(
                                ".message")
                            .val(),
                        type: "get",
                        dataType: "json",
                        success: function(result) {
                            ...
                            if (result.length > 0) {
                                ...
                                $(".chat-messages").append(
                                    `<div class="direct-chat-msg right msg">
                                <div class="direct-chat-infos clearfix">
                                    <span class="direct-chat-name float-right">{{ Auth::guard('teacher')->user()->name }}</span>
