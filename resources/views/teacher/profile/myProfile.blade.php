                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <p class="text-muted text-center">{{ $teacher->job }}</p>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <strong><i class="fa-brands fa-leanpub"></i> {{__('Experience')}}</strong>

                            <p class="text-muted">{{ $teacher->experience }}</p>
                            ...
                            <p class="text-muted">
                                <span class="tag tag-danger">{{ $teacher->skills }}</span>
                            </p>
                        </div>
                        <!-- /.card-body -->
                    </div>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade  show active" id="pills-details" role="tabpanel"
                                    ...
                                    <form class="form-horizontal"
                                        action="{{ route('teacher.profile.update', $teacher->id) }}" method="post"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text"
                                                    ...
                                                    value="{{ old('name', $teacher->name) }}" id="exampleInputName1"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea type="text" name="job" class="form-control  @error('job') is-invalid @enderror" id="inputName"
                                                    placeholder="{{__('Enter Job')}}">{{ old('job', $teacher->job) }}</textarea>
                                                @error('job')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea type="text" name="skills" class="form-control  @error('skills') is-invalid @enderror" rows="2" id="inputName"
                                                    placeholder="{{__('Enter Skills')}}">{{ old('skills', $teacher->skills) }}</textarea>
                                                @error('skills')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea type="text" name="experience" class="form-control  @error('experience') is-invalid @enderror" rows="2" id="inputName"
                                                    placeholder="{{__('Enter Skills')}}">{{ old('experience',  $teacher->experience) }}</textarea>
                                                @error('experience')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($country as $location)
                                                        <option value="{{ $location->id }}"
                                                            @if (old('location', $teacher->location_id) && old('location', $teacher->location_id) == $location->id) selected @endif>
                                                            {{ $location->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
