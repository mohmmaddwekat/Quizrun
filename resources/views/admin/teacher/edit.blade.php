                              ...
                              <div class="col-md-6">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" name="job"
                                          ...
                                          value="{{ old('job', $teacher->job) }}" id="inputName"
                                  ...
                                  <div class="form-group">
                                      ...
                                      <textarea type="text" name="experience" class="form-control  @error('experience') is-invalid @enderror" rows="2"
                                          id="inputName"
                                          placeholder="{{ __('Enter Experience') }}">{{ old('experience', $teacher->experience) }}</textarea>
                                      @error('experience')
                                          <div class="invalid-feedback">
                                              {{ $message }}
                                          </div>
                              ...
                              <div class="col-md-6">
                                  <div class="form-group">
                                      ...
                                      <input type="text" name="education"
                                          ...
                                          value="{{ old('education', $teacher->education) }}" id="inputName"
                                  ...
                                  <div class="form-group">
                                      ...
                                      <img @if (!$teacher->image) id="blah" @endif
                                          src="@if ($teacher->image) {{ url('/assets/uploads/' . $teacher->image) }} @endif"
                                          alt="" width="70px" height="100px" />
                                  </div>
                                  <div class="form-group">
                                      <div class="custom-control custom-switch">
                                          <input type="checkbox" class="custom-control-input" id="isactive"
                                              name="isactive" @if (old('isactive', $teacher->isactive) == 1) checked @endif>
